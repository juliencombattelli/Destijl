...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--with-core=mercury' '--enable-smp'"

/* Build system alias */
#define CONFIG_XENO_BUILD_STRING "armv7l-unknown-linux-gnueabihf"

/* config */
/* #undef CONFIG_XENO_COBALT */

/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 4.9.2 (Raspbian 4.9.2-10) "
...
/* Host system alias */
#define CONFIG_XENO_HOST_STRING "armv7l-unknown-linux-gnueabihf"
...
/* config */
/* #undef CONFIG_XENO_RAW_CLOCK_ENABLED */
